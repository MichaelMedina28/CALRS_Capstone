...
<head>
    ...
    <title>User - Loans Completed</title>
...
<body id="page-top">
                        ...
                        <div class="col-md-9 text-nowrap">
                            <div id="dataTable_length" class="dataTables_length" aria-controls="dataTable">
                                <label class="form-label">
                                    Show&nbsp;
                                    <select class="d-inline-block form-select form-select-sm" id="completedpagecount">
                            ...
                            <div class="input-group">
                                        <input class="bg-light form-control border-0 small" type="text" id="completed-search" placeholder="Search">
                                        <button class="btn btn-primary py-0" type="button" id="completed-search-btn"><i class="fas fa-search"></i></button>
                                    </div>
                            </div>
                        </div>
                        <!--End of Search-->
                            <div class="table-responsive table mt-2" id="dataTable-1" role="grid" aria-describedby="dataTable_info">
                                <table class="table table-hover table-bordered my-0" id="dataTable">
                                    ...
                                    <?php
                                            ...
                                            $query = "SELECT * FROM loan_completed_tbl WHERE user_id = '$userLoginId' ORDER BY loan_id DESC";
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<td button class='d-flex align-items-center'>
                                                          <button class='btn btn-secondary d-flex d-xl-flex justify-content-center align-items-center align-items-xl-center action-btn' data-bss-tooltip='' id='action-btn' type='button' title='View' onclick=\"window.location.href='loans-completed-view.php?id=". $row['loan_id'] ."'\"><i class='far fa-eye'></i></a></button>";
    ...
    <script>
        ...
        const searchButton = document.getElementById("completed-search-btn");
    ...
    //page count button 
document.addEventListener('DOMContentLoaded', function() {
    const rowsSelect = document.getElementById('completedpagecount');
