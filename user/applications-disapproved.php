...
<head>
    ...
    <title>User - Applications Approved</title>
                        ...
                        <ul class="navbar-nav flex-nowrap ms-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#">
                                        ...
                                        </div><img class="border rounded-circle img-profile" id="nav-profile-img" src="../admin/<?php echo $row["account_pictures"] ?>" alt="../assets/img/profile/profile-default.png">
                                    </a>
                            ...
                            <div class="table-responsive table mt-2" id="dataTable-1" role="grid" aria-describedby="dataTable_info">
                                <table class="table table-hover table-bordered my-0" id="dataTable">
                                    ...
                                    <?php
                                            ...
                                            $query = "SELECT * FROM app_disapproved_tbl WHERE user_id = '$userLoginId' ORDER BY loan_id DESC";
