...
$cancelloan = "Cancelled";
$updatesql = "UPDATE app_approved_tbl SET ca_status = ? WHERE loan_id = ?";

$stmt3 = mysqli_prepare($conn, $updatesql);
mysqli_stmt_bind_param($stmt3, "si", $cancelloan, $param_id);
mysqli_stmt_execute($stmt3);
mysqli_stmt_close($stmt3);

header("Location: applications-approved.php?id=" . $user_id);
exit();
}
...
<body id="page-top">
                    ...
                    <form id="myForm" method="post">
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="text-primary m-0 fw-bold"><i class="fas fa-check-circle me-2"></i>Approved CA</p>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="modal fade" role="dialog" tabindex="-1" id="cancel-modal">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Cancel of Loan</h4>
                                                    <button class="btn-close" type="button" aria-label="Close" data-bs-dismiss="modal"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <p class="p-text">Are you sure you want to cancel this loan?</p>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button class="btn btn-danger btn-icon-split m-1" type="submit" name="cancel-btn"><span class="text-white-50 icon"><i class="fas fa-times-circle"></i></span><span class="text-white text">Cancel Loan</span></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-footer">
                                <a class="btn btn-secondary btn-icon-split m-1" href="applications-approved.php?id=<?php echo $row["user_id"]; ?>" ><span class="text-white-50 icon"><i class="fas fa-chevron-circle-left"></i></span><span class="text-white text">Back</span></a>

                                
                                
                                <a class="btn btn-primary btn-icon-split m-1" href="print-ca.php?id=<?php echo $row["loan_id"];?>" ><span class="text-white-50 icon"><i class="fa fa-print"></i></span><span class="text-white text">Print CA</span></a>
                                <a class="btn btn-primary btn-icon-split m-1" href="print-pn.php?id=<?php echo $row["loan_id"];?>" ><span class="text-white-50 icon"><i class="fa fa-print"></i></span><span class="text-white text">Print PN</span></a>
                                <a class="btn btn-primary btn-icon-split m-1" href="print-ds.php?id=<?php echo $row["loan_id"];?>" ><span class="text-white-50 icon"><i class="fa fa-print"></i></span><span class="text-white text">Print DS</span></a>

                                <a class="btn btn-danger btn-icon-split m-1" id="initial-cancel-button" data-bs-target="#cancel-modal" data-bs-toggle="modal"><span class="text-white-50 icon"><i class="fas fa-times-circle"></i></span><span class="text-white text">Cancel Loan</span></a>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    var initialcancelbutton= document.getElementById("initial-cancel-button");
    
    if (caStatusvalue === "Cancelled") {
        initialcancelbutton.style.display = "none";

    }
    if (caStatusvalue === "Released") {
        initialcancelbutton.style.display = "none";
