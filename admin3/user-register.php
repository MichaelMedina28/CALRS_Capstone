                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <div>
                                    ...
                                    <p><strong>Preferred Password</strong></p>
                                    <div class="form-floating mb-3">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input class="form-control form-control" type="text" id="user-spouse-name" placeholder=" " name="user-spouse-name">
                                    ...
                                    <div class="form-floating mb-3"><input class="form-control form-control" type="number" id="user-investment" placeholder="20000" name="share-investment"  onchange="amountLimit()" required><label class="form-label" for="floatingInput">Share on Investment</label></div>
                                    <script>
                                    ...
                                    <div class="mb-3">
                                        <input class="form-control" type="file" id="user-proof-soi" name="user-proof-soi" accept=".jpg,.jpeg,.png,.gif,.bmp|image/*" onchange="validatePicture()" value="<?php echo $row["proof_soi"] ?>" required>
                                    ...
                                    <div class="form-floating mb-3"><input class="form-control form-control-sm" type="email" id="user-email" placeholder=" " autocomplete="on" name="user-email" required><label class="form-label" for="floatingInput">Email Address</label></div>
