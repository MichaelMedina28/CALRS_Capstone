                            ...
                            <div class="table-responsive" role="grid" aria-describedby="dataTable_info">
                                <table class="table table-hover table-bordered my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT * FROM lo_app_pending_tbl ORDER BY loan_id DESC";
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo "<td button class='d-flex align-items-center'>
                                                          <button class='btn btn-primary action-btn p-0' data-bs-toggle='tooltip' data-bss-tooltip='' type='button' title='Manage' onclick=\"window.location.href='applications-pending-manage.php?id=" . $row['loan_id'] . "'\"><i class='fas fa-edit'></i></a></button></td>";
                                                echo "</tr>";
                                            }
                                        }
                                        ?>
