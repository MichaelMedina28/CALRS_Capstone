...
account_pictures = ?, user_mnumber = ?, user_email = ?, user_pdocument_type = ?, pdocument = ? , user_status = ?,position = ?, spouse_name = ?, share_investment = ? , proof_soi = ? WHERE user_id = ?";
...
$updated_user_pass = password_hash($_POST['user-pass'], PASSWORD_DEFAULT);
...
// File details
$fileName = "$update_fname $updated_mname $updated_lname - (UPDATED)" .$file["name"];
...
// File details
$file2Name = "$update_fname $updated_mname $updated_lname - (PROOF_SOI)" .$file2["name"];
...
// File details
$documentName = "$update_fname $updated_mname $updated_lname - (UPDATED)" .$document["name"];
...
$stmt->bind_param("ssssssssssssssssssssssi", $updated_lname, $update_fname, $updated_mname, $updated_sfxname, $updated_user_pass, $updated_user_pass_confirm,
...
$pdocument, $user_status, $user_position, $user_spouseName, $share_investment,  $file2destination, $userId);
                ...
                <div class="container-fluid">
                    ...
                    <form>
                        <div class="card shadow">
                            ...
                            <a class="btn btn-secondary btn-icon-split m-1" type="submit" href="user-pending.php"><span class="text-white-50 icon"><i class="fas fa-chevron-circle-left"></i></span><span class="text-white text">Back</span></a>
