                            ...
                            <div class="table-responsive text-nowrap table mt-2" role="grid" aria-describedby="dataTable_info">
                                <table class="table table-hover table-bordered my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT * FROM user_tbl WHERE share_investment < 20000 AND profile NOT IN ('admin', 'admin2', 'admin3') ORDER BY user_id DESC";
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                $numeric_value = (float) str_replace(',', '', $row['share_investment']);
                                                $formatted_value = number_format($numeric_value, 2, '.', ',');
                                                ...
                                                echo "<td>
                                                    <button class='btn btn-primary action-btn p-0' data-bs-toggle='tooltip' data-bss-tooltip='' type='button' title='Manage' onclick=\"window.location.href='user-pending-update.php?id=" . $row['user_id'] . "'\"><i class='fas fa-edit'></i></button>
                                                    </td>";
                                                echo "</tr>";
                                            }
                                        } else {
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="10"><strong>Total Pending Users: <?php echo $queryResult; ?></strong></td>
