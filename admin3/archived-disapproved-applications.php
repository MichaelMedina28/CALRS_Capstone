...
<body id="page-top">
                            ...
                            <div class="row">
                                <div class="col-md-9 text-nowrap">
                                    <div id="dataTable_length" class="dataTables_length" aria-controls="dataTable">
                                        <label class="form-label">
                                            Show&nbsp;
                                            <select class="d-inline-block form-select form-select-sm" id="pendingpagecount">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <input class="bg-light form-control border-0 small" type="text" id="pending-search" placeholder="Search">
                                        <button class="btn btn-primary py-0" type="button" id="pending-search-btn"><i class="fas fa-search"></i></button>
                                    </div>
                                </div>
                            </div>
                            <!--End of Search-->
                            <div class="table-responsive" role="grid" aria-describedby="dataTable_info">
                                <table class="table table-hover table-bordered my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT * FROM arc_app_disapproved_tbl ORDER BY loan_id DESC";
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo "<td button class='d-flex align-items-center'>
                                                          <button class='btn btn-secondary action-btn p-0' data-bs-toggle='tooltip' data-bss-tooltip='' type='button' title='View' onclick=\"window.location.href='archived-disapproved-applications-view.php?id=" . $row['loan_id'] . "'\"><i class='fas fa-eye'></i></a></button></td>";
                                                echo "</tr>";
                                            }
                                        }
                                        ?>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="10"><strong>Total Archived Disapproved Applications: <?php echo $queryResult; ?></strong></td>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const searchButton = document.getElementById("pending-search-btn");
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const rowsSelect = document.getElementById('pendingpagecount');
            const tableRows = document.querySelectorAll('#pendingTable tbody tr');
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const rowsSelect = document.getElementById('pendingpagecount');
            const tableRows = document.querySelectorAll('#pendingTable tbody tr'); // Select all table rows
