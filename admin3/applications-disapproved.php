                            ...
                            <div class="table-responsive" role="grid" aria-describedby="dataTable_info">
                                <table class="table table-hover table-bordered my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT * FROM app_disapproved_tbl";
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo "<td button class='d-flex align-items-center'>
                                                          <button class='btn btn-secondary action-btn p-0' data-bs-toggle='tooltip' data-bss-tooltip='' type='button' title='View' onclick=\"window.location.href='applications-disapproved-view.php?id=" . $row['loan_id'] . "'\"><i class='fas fa-eye'></i></a></button></td>";
                                                echo "</tr>";
                                            }
                                        }
                                        // Get the current date
                                            ...
                                            $insertQuery = "INSERT INTO arc_app_disapproved_tbl SELECT * FROM app_disapproved_tbl WHERE date_agreement <= '$fiveYearsAgo'";
                                            $result = mysqli_query($conn, $insertQuery); 

                                            $deleteQuery = "DELETE FROM app_disapproved_tbl WHERE date_agreement <= '$fiveYearsAgo'";
