...
$sql = "SELECT * FROM arc_app_approved_tbl WHERE loan_id = ?";
...
if (isset($_POST['update'])) {
    ...
    if ($stmt = mysqli_prepare($conn, $sql)) {
        ...
        $description = "The disbursement status of $loanId is now For Release";
        ...
        //For Login Logs
        $description = "Your Disbursement status is now For Release";
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="fw-bold text-dark">Archived</h3>
                    <form id="myForm" method="post">
                        <div class="card shadow">
                            ...
                            <div class="card-footer">
                                <a class="btn btn-secondary btn-icon-split m-1" href="archived-approved-applications.php"><span class="text-white-50 icon"><i class="fas fa-chevron-circle-left"></i></span><span class="text-white text">Back</span></a>
                                <a class="btn btn-primary btn-icon-split m-1" id="print-ca" href="archived-approved-print-ca.php?id=<?php echo $row["loan_id"];?>"><span class="text-white-50 icon"><i class="fas fa-print"></i></span><span class="text-white text">Print CA</span></a>
                                <a class="btn btn-primary btn-icon-split m-1" id="print-pn" href="archived-approved-print-pn.php?id=<?php echo $row["loan_id"];?>"><span class="text-white-50 icon"><i class="fas fa-print"></i></span><span class="text-white text">Print PN</span></a>
                                <a class="btn btn-primary btn-icon-split m-1" id="print-ds" href="archived-approved-print-ds.php?id=<?php echo $row["loan_id"];?>.php"><span class="text-white-50 icon"><i class="fas fa-print"></i></span><span class="text-white text">Print DS</span></a>
                            </div>
