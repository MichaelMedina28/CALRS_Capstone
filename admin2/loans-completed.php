                ...
                <h3 class="fw-bold text-dark">Loans</h3>
                    <div class="card shadow">
                        ...
                        <div class="col-md-3 d-flex justify-content-end align-items-start">
                            <a class="btn btn-primary btn-icon-split m-1" id="printAuditTrailButton" href="print-at.php"><span class="text-white-50 icon"><i class="fas fa-file-export"></i></span><span class="text-white text">Print Audit Trails</span></a>
                        </div>
                            <div class="col-md-3">
