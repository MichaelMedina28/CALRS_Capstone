        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form id="user-register" method="post" enctype="multipart/form-data" action="user-approved-update-confirm.php?id=<?php echo urlencode($row["user_id"]); ?>">
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <div class="col">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input class="form-control" type="password" id="user-pass" placeholder=" " required="" minlength="8" maxlength="20" name="user-pass" value="<?php echo $row["user_pass"] ?>" oninput="validatePassword()"><label class="form-label" for="floatingInput">Password</label></div>
                                    ...
                                    <div class="form-floating mb-3"><input class="form-control form-control" type="number" id="user-address-subd-1" placeholder=" " name="share-investment" value="<?php echo $row["share_investment"] ?>"><label class="form-label" for="floatingInput">Share on Investment</label></div>
                            ...
                            <div class="card-footer"><a class="btn btn-secondary btn-icon-split m-1" href="user-approved.php"><span class="text-white-50 icon"><i class="fas fa-chevron-circle-left"></i></span><span class="text-white text">Back</span></a>
