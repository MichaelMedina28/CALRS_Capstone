                            ...
                            <div class="table-responsive" role="grid" aria-describedby="dataTable_info">
                                <table class="table table-hover table-bordered my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT * FROM app_pending_tbl";
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo "<td button class='d-flex align-items-center'>
                                                          <button class='btn btn-secondary action-btn p-0' data-bs-toggle='tooltip' data-bss-tooltip='' type='button' title='View' onclick=\"window.location.href='applications-approved-view.php?id=" . $row['loan_id'] . "'\"><i class='fas fa-eye'></i></a></button></td>";
                                                echo "</tr>";
                                            }
                                        }
                                        ?>
