...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE arc_completedloan_tbl SET 
                    ...
                    <form method="post">
                        <div class="card shadow">
                            ...
                            <div class="card-footer">
                                <a class="btn btn-secondary btn-icon-split m-1" href="archived-completed-loans.php"><span class="text-white-50 icon"><i class="fas fa-chevron-circle-left"></i></span><span class="text-white text">Back</span></a>
                                <a class="btn btn-primary btn-icon-split m-1" id="print-ca" href="archived-completed-print-soa.php?id=<?php echo $row["loan_id"];?>"><span class="text-white-50 icon"><i class="fas fa-print"></i></span><span class="text-white text">Print SOA</span></a>
                            </div>
                        </div>
                    </form>
