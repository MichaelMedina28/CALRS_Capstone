...
<body>
    ...
    <div class="row d-xl-flex">
        <div class="col d-flex justify-content-end bg-white">
            <a class="btn btn-secondary btn-icon-split m-1" href="archived-completed-loans-view.php?id=<?php echo $row["loan_id"];?>""><span class="text-white-50 icon"><i class="fas fa-chevron-circle-left"></i></span><span class="text-white text">Back</span></a>
    ...
    function removeButtonsFromPrintContent(content) {
        ...
        printContent = printContent.replace(/<a[^>]*href=['"]?archived-completed-loans-view\.php[^>]*>.*?<\/a>/gi, '');
        return printContent;
    }
</script>
