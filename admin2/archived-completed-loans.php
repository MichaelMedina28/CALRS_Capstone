                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold"><i class="fas fa-check-circle me-2"></i>Completed Loans</p>
                        </div>
                        <div class="card-body">
                            <!--Start of Search-->
                            <div class="row">
                            ...
                            <div class="table-responsive" role="grid" aria-describedby="dataTable_info">
                                <table class="table table-hover table-bordered my-0" id="dataTable">
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo "<td button class='d-flex align-items-center'>
                                                          <button class='btn btn-secondary action-btn p-0' data-bs-toggle='tooltip' data-bss-tooltip='' type='button' title='View' onclick=\"window.location.href='archived-completed-loans-view.php?id=" . $row['loan_id'] . "'\"><i class='fas fa-eye'></i></a></button></td>";
                                                echo "</tr>";
                                            }
                                        }
                                        ?>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="10"><strong>Total Archived Completed Applications: <?php echo $queryResult; ?></strong></td>
