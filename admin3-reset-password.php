...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare('SELECT * FROM admin3_tbl WHERE admin_email = ?');
    ...
    if ($result->num_rows > 0) {
        ...
        $sqlUpdateToken = "UPDATE admin3_tbl SET reset_token = ? WHERE admin_email = ?";
        ...
        try {
            ...
            $mail->Body    = 'To reset your password, click this link: <a href="https://crg-mpc-calrs.rf.gd/admin3-pass-reset.php?token=' . $resetToken . '">Reset Password</a>';
