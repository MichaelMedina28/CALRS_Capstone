...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        $sqlUpdateToken = "UPDATE user_tbl SET reset_token = ? WHERE user_email = ?";
        ...
        try {
            ...
            $mail->Body    = 'To reset your password, click this link: <a href="https://crg-mpc-calrs.rf.gd/pass-reset.php?token=' . $resetToken . '">Reset Password</a>';
