...
if (isset($_POST['delete'])) {
    $loanId = $_GET['id'];
    $sql = "DELETE from app_disapproved_tbl where loan_id = ?";
...
$conn->close();
header("Location: applications-disapproved.php");
}
?>
                    ...
                    <form method="post">
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="text-primary m-0 fw-bold">Application Form</p>
                            </div>
                            <div class="card-body">
                                <p class="p-text">Are you sure you want to permanently <strong><span style="color: rgb(231, 74, 59);">DELETE&nbsp;</span></strong>this Application Form from the list?</p>
                            </div>
                            <div class="card-footer">
                            <a class="btn btn-secondary btn-icon-split m-1" href="applications-disapproved.php"><span class="text-white-50 icon"><i class="fas fa-times-circle"></i></span><span class="text-white text">No</span></a>
                            <button class="btn btn-danger btn-icon-split m-1" name="delete" id="update-btn-confirm" type="submit"><span class="text-white-50 icon"><i class="fas fa-trash"></i></span><span class="text-white text">Yes</span></button></div>
                        </div>
                    </form>
                </div>
            </div>
