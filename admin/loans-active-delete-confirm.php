...
if (isset($_POST['delete'])) {
    $loanId = $_GET['id'];
    $sql = "INSERT INTO arc_activeloan_tbl SELECT * FROM loan_active_tbl where loan_id = ?";
                ...
                <div class="container-fluid">
                    ...
                    <form method="post">
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <p class="p-text">Are you sure you want to <strong><span style="color: rgb(231, 74, 59);">DELETE</span></strong>&nbsp;this <strong><span style="color: rgb(78, 115, 223);">Active Loan</span></strong>? This will remove the record from the list and nullify the contract of an existing loan.</p>
                            </div>
                            <div class="card-footer">
                                <a class="btn btn-secondary btn-icon-split m-1" href="loans-active.php" ><span class="text-white-50 icon"><i class="fas fa-times-circle"></i></span><span class="text-white text">No</span></a>
