        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form id="user-register" method="post" enctype="multipart/form-data" action="user-manage-update-confirm.php?id=<?php echo urlencode($row["user_id"]); ?>">
                        <div class="card shadow">
                            ...
                            <div class="card-footer"><a class="btn btn-secondary btn-icon-split m-1" href="user-manage.php"><span class="text-white-50 icon"><i class="fas fa-chevron-circle-left"></i></span><span class="text-white text">Back</span></a>
