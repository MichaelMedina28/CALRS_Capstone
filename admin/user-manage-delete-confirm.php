        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="fw-bold text-dark">Delete - Confirm</h3>
                    <form method="post">
                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <p class="p-text">Are you sure you want to <strong><span style="color: rgb(231, 74, 59);">DELETE</span></strong> this User?</p>
                            </div>
                            <div class="card-footer">
                            <a class="btn btn-secondary btn-icon-split m-1" type="button" href="user-manage.php" ><span class="text-white-50 icon"><i class="fas fa-times-circle"></i></span><span class="text-white text">No</span></a>
                            <button class="btn btn-danger btn-icon-split m-1" name="delete" id="delete-btn-confirm" type="submit"><span class="text-white-50 icon"><i class="fas fa-trash"></i></span><span class="text-white text">Yes</span></button></div>
                        </div>
                    </form>
                </div>
            </div>
