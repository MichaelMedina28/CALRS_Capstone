...
account_pictures = ?, user_mnumber = ?, user_email = ?, user_pdocument_type = ?, pdocument = ? , position = ?, spouse_name = ?, share_investment = ? WHERE user_id = ?";
...
$stmt->bind_param("ssssssssssssssssssssi", $updated_lname, $update_fname, $updated_mname, $updated_sfxname, $updated_user_pass, $updated_user_pass_confirm,
...
$pdocument, $user_position, $user_spouseName, $share_investment, $userId);
