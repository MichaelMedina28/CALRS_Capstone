...
<body id="page-top">
                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <div>
                                    ...
                                    <div class="form-floating mb-3"><input class="form-control form-control" type="text" id="user-lname" placeholder=" " autocomplete="on" required="" name="user-lname" oninput="capitalizeFirstLetter('user-lname')"><label class="form-label" for="floatingInput">Surname / Last Name</label></div>
                                    <div class="form-floating mb-3"><input class="form-control form-control" type="text" id="user-fname" placeholder=" " required="" name="user-fname" oninput="capitalizeFirstLetter('user-fname')"><label class="form-label" for="floatingInput">Given Name / First Name</label></div>
                                    <div class="form-floating mb-3"><input class="form-control form-control" type="text" id="user-mname" placeholder=" " name="user-mname" oninput="capitalizeFirstLetter('user-mname')"><label class="form-label class-name" for="floatingInput">Middle Name</label></div>
                                    ...
                                    <div class="form-floating mb-3"><input class="form-control form-control" type="number" id="user-address-subd-1" placeholder=" " name="share-investment"><label class="form-label" for="floatingInput">Share on Investment</label></div>
                                    <div class="form-floating mb-3"><input class="form-control form-control" type="text" id="user-address-subd-1" placeholder=" " name="user-spouse-name"><label class="form-label" for="floatingInput">Spouse Name</label></div>
                            ...
                            <div class="card-footer d-xl-flex justify-content-xl-end">
                                <button class="btn btn-success btn-icon-split m-1" id="user-register-register" type="submit" name="register-btn"><span class="text-white text">Register</span><span class="text-white-50 icon"><i class="fas fa-user-plus"></i></span></button>
                            </div>
    ...
    <script>
        const userRegisterRegister = document.getElementById('user-register-register');
