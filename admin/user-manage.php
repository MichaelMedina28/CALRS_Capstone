            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        ...
                        <p class="text-primary m-0 fw-bold"><i class="fas fa-info-circle me-2"></i>Total Users</p>
                        </div>
                        <div class="card-body">
                            <!--Start of Search-->
                            <div class="row">
                            ...
                            <div class="table-responsive text-nowrap table mt-2" role="grid" aria-describedby="dataTable_info">
                                <table class="table table-hover table-bordered my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo "<td>" . $row['share_investment'] . "</td>";
                                                ...
                                                echo "<td>
                                                    <button class='btn btn-secondary action-btn p-0' data-bs-toggle='tooltip' data-bss-tooltip='' type='button' title='Manage' onclick=\"window.location.href='user-manage-view.php?id=" . $row['user_id'] . "'\"><i class='fas fa-eye'></i></button>
                                                    </td>";
                                                echo "</tr>";
                                            }
                                        } else {
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="10"><strong>Total Users: <?php echo $queryResult; ?></strong></td>
