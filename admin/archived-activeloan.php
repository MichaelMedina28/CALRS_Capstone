...
<body id="page-top">
                        ...
                        <div class="col-md-9 text-nowrap">
                            <div id="dataTable_length" class="dataTables_length" aria-controls="dataTable">
                                <label class="form-label">
                                    Show&nbsp;
                                    <select class="d-inline-block form-select form-select-sm" id="arc-activepagecount">
                            ...
                            <div class="input-group">
                                        <input class="bg-light form-control border-0 small" type="text" id="arc-active-search" placeholder="Search">
                                        <button class="btn btn-primary py-0" type="button" id="arc-active-search-btn"><i class="fas fa-search"></i></button>
                                    </div>
                            </div>
                        </div>
                        <!--End of Search-->
                            <div class="table-responsive table mt-2" id="dataTable-1" role="grid" aria-describedby="dataTable_info">
                                <table class="table table-hover table-bordered my-0" id="dataTable">
                                    ...
                                    <?php
                                            ...
                                            $query = "SELECT * FROM arc_activeloan_tbl ORDER BY loan_id DESC";
                                    ...
                                    <tfoot>
                                    <tr>
                                        <td colspan="10"><strong>Total Archived Active Loans: <?php echo $queryResult; ?></strong></td>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        const searchButton = document.getElementById("arc-active-search-btn");
        const searchInput = document.getElementById("arc-active-search");
    ...
    document.addEventListener('DOMContentLoaded', function() {
    const rowsSelect = document.getElementById('arc-activepagecount');
