...
if (isset($_POST['delete'])) {
    $loanId = $_GET['id'];
    $sql = "DELETE from arc_activeloan_tbl where loan_id = ?";
                    ...
                    <form method="post">
                        <div class="card shadow">
                            ...
                            <div class="card-footer">
                                <a class="btn btn-secondary btn-icon-split m-1" href="archived-activeloan.php" ><span class="text-white-50 icon"><i class="fas fa-times-circle"></i></span><span class="text-white text">No</span></a>
