...
<head>
    ...
    <title>Admin - Loans Completed</title>
                        ...
                        <!--End of Search-->
                            ...
                            <table class="table table-hover table-bordered my-0" id="dataTable">
                                    ...
                                    <?php
                                            ...
                                            $query = "SELECT * FROM loan_completed_tbl ORDER BY loan_id DESC";
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<td button class='d-flex align-items-center'>
                                                          <button class='btn btn-secondary action-btn p-0' data-bs-toggle='tooltip' data-bss-tooltip='' type='button' title='View' onclick=\"window.location.href='loans-completed-view.php?id=" . $row['loan_id'] . "'\"><i class='fas fa-eye'></i></a></button></td>";
                                                    echo "</tr>"; 
                                                }
                                            } 
                                            ...
                                            $insertQuery = "INSERT INTO arc_completedloan_tbl SELECT * FROM loan_completed_tbl WHERE term_start <= '$fiveYearsAgo'";
                                            $result = mysqli_query($conn, $insertQuery); 

                                            $deleteQuery = "DELETE FROM loan_completed_tbl WHERE term_start <= '$fiveYearsAgo'";
...
$(document).ready(function () {
    $("#printButton").on("click", function () {
        ...
        tableContent.find('td:nth-child(9), th:nth-child(9)').remove();
