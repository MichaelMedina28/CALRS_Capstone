                    ...
                    <div class="card shadow">
                        ...
                        <!--End of Search-->
                            <div class="table-responsive" role="grid" aria-describedby="dataTable_info">
                                <table class="table table-hover table-bordered my-0" id="pendingTable">
                                    <thead>
                                        <tr>
                                            <th>Loan ID</th>
                                            <th>User ID</th>
                                    ...
                                    <?php
                                            ...
                                            $query = "SELECT * FROM app_pending_tbl ORDER BY loan_id DESC";
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<td button class='d-flex align-items-center'>
                                                        <button class='btn btn-primary d-flex d-xl-flex justify-content-center align-items-center align-items-xl-center action-btn' data-bss-tooltip='' id='action-btn' type='button' title='View' onclick=\"window.location.href='applications-pending-approve.php?id=". $row['loan_id'] ."'\"><i class='fas fa-edit'></i></a></button>";
                                                    echo "</tr>";
                                        }
                                        } 
                                        ?>
                                    ...
                                    <tfoot>
                                    <tr>
                                        <td colspan="10"><strong>Total Pending Applications: <?php echo $queryResult; ?></strong></td>
