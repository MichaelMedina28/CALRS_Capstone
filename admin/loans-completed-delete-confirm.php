...
if (isset($_POST['delete'])) {
    $loanId = $_GET['id'];
    $sql = "INSERT INTO arc_completedloan_tbl SELECT * FROM loan_completed_tbl where loan_id = ?";
    $sql2 = "DELETE from loan_completed_tbl where loan_id = ?";
      ...
      header("Location: loans-completed.php");
}
?>
<!DOCTYPE html>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="fw-bold text-dark">Archive - Confirm</h3>
                    <form method="post">
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="text-primary m-0 fw-bold">Completed Loan</p>
                            </div>
                            <div class="card-body">
                                <p class="p-text">Are you sure you want to <strong><span style="color: rgb(231, 74, 59);">ARCHIVE</span></strong>&nbsp;this <strong><span style="color: rgb(78, 115, 223);">Completed Loan</span></strong>?</p>
                            </div>
                            <div class="card-footer">
                                <a class="btn btn-secondary btn-icon-split m-1" href="loans-completed.php" ><span class="text-white-50 icon"><i class="fas fa-times-circle"></i></span><span class="text-white text">No</span></a>
