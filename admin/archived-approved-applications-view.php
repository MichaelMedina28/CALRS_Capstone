                    ...
                    <form id="myForm" method="post">
                        <div class="card shadow">
                            ...
                            <div class="card-footer">
                                ...
                                <a class="btn btn-primary btn-icon-split m-1" id="print-ds" href="archived-approved-print-ds.php?id=<?php echo $row["loan_id"];?>"><span class="text-white-50 icon"><i class="fas fa-print"></i></span><span class="text-white text">Print DS</span></a>
                            </div>
