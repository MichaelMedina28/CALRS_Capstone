...
<head>
    ...
    <meta name="description" content="Applications For Approval">
...
<body id="page-top">
                        ...
                        <div class="col-md-9 text-nowrap">
                            <div id="dataTable_length" class="dataTables_length" aria-controls="dataTable">
                                <label class="form-label">
                                    Show&nbsp;
                                    <select class="d-inline-block form-select form-select-sm" id="forapprovalpagecount">
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table table-hover table-bordered my-0" id="dataTable">
                                    ...
                                    <?php
                                            ...
                                            $query = "SELECT * FROM app_approved_tbl ORDER BY loan_id DESC";
                                            ...
                                            $insertQuery = "INSERT INTO arc_app_approved_tbl SELECT * FROM app_approved_tbl WHERE date_agreement <= '$fiveYearsAgo'";
                                            $result = mysqli_query($conn, $insertQuery); 

                                            $deleteQuery = "DELETE FROM app_approved_tbl WHERE date_agreement <= '$fiveYearsAgo'";
    ...
    document.addEventListener('DOMContentLoaded', function() {
    const rowsSelect = document.getElementById('forapprovalpagecount');
