...
$description = "$adminUsername notify $user_id about the overdue payment.($loanId)";
...
// Records updated successfully. Proceed with $sql2
$notif_description = "Your payment is now overdue by $da_amortization_date1 | $da_amortization_date2 ($loanId)";
                    ...
                    <form method="post"> 
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="text-primary m-0 fw-bold">Payment Overdue</p>
                            </div>
                            <div class="card-body">
                                <p class="p-text">Are you sure you want to <strong><span style="color: rgb(231, 74, 59);">NOTIFY</span></strong>&nbsp;the user to his/her payment overdue?</p>
                            </div>
