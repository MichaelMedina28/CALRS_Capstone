...
<head>
    ...
    <meta name="description" content="Applications Disapproved">
...
<body id="page-top">
                ...
                <nav class="navbar navbar-expand bg-white shadow mb-4 topbar static-top navbar-light">
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle me-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        <div class="d-flex d-xl-flex flex-column align-items-start justify-content-xl-start">
                            ...
                            <div><i class="far fa-clock text-primary me-1"></i><span id="current-time" class="current-datetime">1:00:00 AM</span></div>
                        </div>
                        <ul class="navbar-nav flex-nowrap ms-auto">
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#">
                                        <div class="d-flex flex-column align-items-lg-end"><span class="d-none d-lg-inline me-2 text-gray-600 small"><?php echo $_SESSION["admin_fname"];?> <?php echo $_SESSION["admin_lname"];?></span><span class="d-none d-lg-inline me-2 text-gray-600 small">ADMIN</span></div><img class="border rounded-circle img-profile" src="../assets/img/profile/profile-default.png">
                                    </a>
                ...
                <h3 class="fw-bold text-dark">Applications</h3>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold"><i class="fas fa-times-circle me-2"></i>Disapproved CA</p>
                        </div>
                        <div class="card-body">
                        <!--Start of Search-->
                        <div class="row">
                        <div class="col-md-9 text-nowrap">
                            <div id="dataTable_length" class="dataTables_length" aria-controls="dataTable">
                                <label class="form-label">
                                    Show&nbsp;
                                    <select class="d-inline-block form-select form-select-sm" id="disapprovedpagecount">
                            ...
                            <div class="input-group">
                                        <input class="bg-light form-control border-0 small" type="text" id="disapproved-search" placeholder="Search">
                                        <button class="btn btn-primary py-0" type="button" id="disapproved-search-btn"><i class="fas fa-search"></i></button>
                                    </div>
                            </div>
                        </div>
                        <!--End of Search-->
                            <div class="table-responsive table mt-2" role="grid" aria-describedby="dataTable_info">
                                <table class="table table-hover table-bordered my-0" id="dataTable">
                                    ...
                                    <?php
                                            ...
                                            $query = "SELECT * FROM app_disapproved_tbl ORDER BY loan_id DESC";
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<td>" . $row['date_agreement'] . "</td>";
                                                    echo "<td>" . $row['position'] . "</td>";
                                                    echo "<td>" . $row['amount_number'] . "</td>";
                                                    echo "<td button class='d-flex align-items-center'><button class='btn btn-secondary d-flex d-xl-flex justify-content-center align-items-center align-items-xl-center action-btn' data-bss-tooltip='' id='action-btn' type='button' title='View' onclick=\"window.location.href='applications-disapproved-view.php?id=". $row['loan_id'] ."'\"><i class='fas fa-eye'></i></a></button>";
                                    ...
                                    <tfoot>
                                    <tr>
                                        <td colspan="10"><strong>Total Disapproved Applications: <?php echo $queryResult; ?></strong></td>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        const searchButton = document.getElementById("disapproved-search-btn");
        const searchInput = document.getElementById("disapproved-search");
    ...
    document.addEventListener('DOMContentLoaded', function() {
    const rowsSelect = document.getElementById('disapprovedpagecount');
