                ...
                <div class="container-fluid">
                    ...
                    <?php
                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <p class="p-text">Successfully <strong><span style="color: rgb(231, 74, 59);">DELETE</span></strong> the User&nbsp;</p>
                            </div>
                            <div class="card-footer">
                            <a class="btn btn-secondary btn-icon-split m-1" type="button" href="user-manage.php" ><span class="text-white-50 icon"><i class="fas fa-times-circle"></i></span><span class="text-white text">Back</span></a>
