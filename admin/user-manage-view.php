                    ...
                    <form id="user-register" method="post" enctype="multipart/form-data" action="user-pending-update-confirm.php?id=<?php echo urlencode($row["user_id"]); ?>">
                        <div class="card shadow">
                            <div class="card-header py-3">
                                <p class="text-primary m-0 fw-bold"><i class="fas fa-info-circle me-2"></i>Approved User Manage</p>
                            </div>
                            <div class="card-body">
                                <div class="col">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input class="form-control" type="password" id="user-pass" placeholder=" " required="" minlength="8" maxlength="20" name="user-pass" value="<?php echo $row["user_pass"] ?>" oninput="validatePassword()" disabled><label class="form-label" for="floatingInput">Password</label></div>
                                        <p id="passwordError" style="color: red;"></p>
                                    <div class="form-floating mb-3"><input class="form-control" type="password" id="user-pass-confirm" placeholder=" " required="" minlength="8" maxlength="20" name="user-pass-confirm" value="<?php echo $row["user_pass_confirm"] ?>" disabled><label class="form-label" for="floatingInput">Confirm Password</label></div>
                                    ...
                                    <div class="form-floating mb-3"><input class="form-control form-control" type="text" id="user-lname"  placeholder=" " autocomplete="on" required="" name="user-lname" oninput="capitalizeFirstLetter('user-lname')" value="<?php echo $row["user_lname"] ?>" disabled><label class="form-label" for="floatingInput">Surname / Last Name</label></div>
                                    <div class="form-floating mb-3"><input class="form-control form-control" type="text" id="user-fname" placeholder=" " required="" name="user-fname" oninput="capitalizeFirstLetter('user-fname')" value="<?php echo $row["user_fname"] ?>" disabled><label class="form-label" for="floatingInput">Given Name / First Name</label></div>
                                    <div class="form-floating mb-3"><input class="form-control form-control" type="text" id="user-mname" placeholder=" " name="user-mname" oninput="capitalizeFirstLetter('user-mname')" value="<?php echo $row["user_mname"] ?>" disabled><label class="form-label" for="floatingInput">Middle Name</label></div>
                                    ...
                                    <div class="mb-3"><input class="form-control form-control" id="user-birthdate" type="date" required="" name="user-birthdate" max="2002-12-31" min="1958-12-30" value="<?php echo $row["user_birthdate"] ?>" disabled></div>
                                    <p><strong>Address</strong></p>
                                    <div class="form-floating mb-3"><input class="form-control form-control" type="text" id="user-address-room" placeholder=" " name="user-address-room" value="<?php echo $row["user_address_room"] ?>" disabled><label class="form-label" for="floatingInput">Room / Floor / Unit No. &amp; Building Name</label></div>
                                    <div class="form-floating mb-3"><input class="form-control form-control" type="text" id="user-address-house" placeholder=" " name="user-address-house" value="<?php echo $row["user_address_house"] ?>" disabled><label class="form-label" for="floatingInput">House / Lot &amp; Block No.</label></div>
                                    <div class="form-floating mb-3"><input class="form-control form-control" type="text" id="user-address-street" placeholder=" " required="" name="user-address-street" value="<?php echo $row["user_address_street"] ?>" disabled><label class="form-label" for="floatingInput">Street</label></div>
                                    <div class="form-floating mb-3"><input class="form-control form-control" type="text" id="user-address-subd" placeholder=" " name="user-address-subd" value="<?php echo $row["user_address_subd"] ?>" disabled><label class="form-label" for="floatingInput">Subdivision</label></div>
                                    ...
                                    <div class="form-floating mb-3">
                                        <select class="form-select form-select" id="user-position" for="floatinginput" required="" name="user-position" disabled>
                                    ...
                                    <div class="form-floating mb-3"><input class="form-control form-control" type="number" id="user-address-subd-1" placeholder=" " name="share-investment" value="<?php echo $row["share_investment"] ?>" disabled><label class="form-label" for="floatingInput">Share on Investment</label></div>
                                    <div class="form-floating mb-3"><input class="form-control form-control" type="text" id="user-address-subd-1" placeholder=" " name="user-spouse-name" value="<?php echo $row["spouse_name"] ?>" disabled><label class="form-label" for="floatingInput">Spouse Name</label></div>
                                    ...
                                    <div class="mb-3">
                                        <input class="form-control" type="file" id="user-picture-profile" name="user-picture-profile" accept=".jpg,.jpeg,.png,.gif,.bmp|image/*" onchange="validatePicture()" value="<?php echo $row["account_pictures"] ?>" disabled>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="d-xl-flex justify-content-xl-center">
                                                        <img class="img-fluid" src="<?php echo $row['account_pictures']; ?>" alt="The user does not submit an account picture">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="form-floating mb-3"><input class="form-control form-control-sm" type="text" id="user-mnumber" required="" placeholder=" " name="user-mnumber" value="<?php echo $row["user_mnumber"] ?>" disabled><label class="form-label" for="floatingInput">Contact Number</label></div>
                                    <p id="error-message" style="color: red;"></p>
                                    <p><strong>Email</strong><br><span style="color: rgb(231, 74, 59);">Please do not block crgmpc@gmail.com messages</span></p>
                                    <div class="form-floating mb-3"><input class="form-control form-control-sm" type="email" id="user-email" placeholder=" " autocomplete="on" name="user-email" value="<?php echo $row["user_email"] ?>" disabled><label class="form-label" for="floatingInput">Email Address</label></div>
                                    ...
                                    <div class="mb-3">
                                        <div class="form-floating mb-3"><select class="form-select form-select" id="user-pdocument-type" for="floatinginput" required="" name="user-pdocument-type" disabled>
                                            ...
                                            <label class="form-label" for="floatinginput">Preferred Document Type</label></div>
                                                <input class="form-control" type="file" id="user-pdocument" name="user-pdocument" name="user-pdocument" accept=".pdf,.jpg,.jpeg,.png,.gif,.bmp|image/*" onchange="validateDocument()" disabled>
                                                <!-- Hidden Input for Preferred Document Type -->
                                                <input type="hidden" name="existing-pdocument" value="<?php echo $row["pdocument"]; ?>" disabled>
                                        </div>
                                    ...
                                    <div class="modal fade" role="dialog" tabindex="-1" id="modal-2">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="d-xl-flex justify-content-xl-center">
                                                        <img class="img-fluid" src="<?php echo $row['pdocument']; ?>" alt="The user does not submit an account picture">
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <a class="btn btn-secondary btn-icon-split m-1" role="button" data-bs-dismiss="modal">
                                    ...
                                    <div class="form-floating mb-3">
                                        <select class="form-select form-select" id="user-status" for="floatinginput" required="" name="user-status" disabled>
                            ...
                            <a class="btn btn-secondary btn-icon-split m-1" href="user-manage.php"><span class="text-white-50 icon"><i class="fas fa-chevron-circle-left"></i></span><span class="text-white text">Back</span></a>
